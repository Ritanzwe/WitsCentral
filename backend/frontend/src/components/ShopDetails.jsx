...
import './ShopDetails.css'; // Custom CSS for extra styling
...
const ShopDetails = () => {
  ...
  return (
    <>
      <NavBar />
      <div className="shop-details container mt-5">
        <div className="text-center mb-5">
          <h1>Welcome to {shop.name}!</h1>
          <p>Explore the shop, check out its products, or make some changes!</p>
        </div>
        ...
        <div className="row mb-5">
          ...
          <div className="col-md-8">
            ...
            <div className="mt-4">
              ...
              <button className="btn btn-danger" onClick={handleDeleteShop}>
                Delete Shop
              </button>
            </div>
          </div>
